...
from test_framework.respubliqa_node import ResPubliqaTestNode
...
class ResPubliqa_ColdStakingTest(ResPubliqaTestFramework):
    ...
    def init_test(self):
        ...
        for i in range(self.num_nodes):
            self.test_nodes.append(ResPubliqaTestNode())
    ...
    def run_test(self):
        ...
        # Create the block
        new_block = self.stake_next_block(1, stakeInputs, None, staker_privkey)
        # Add output (dummy key address) to coinstake (taking 100 RSQ from the pot)
...
if __name__ == '__main__':
    ResPubliqa_ColdStakingTest().main()
