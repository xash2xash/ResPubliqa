...
class RawTransactionsTest(ResPubliqaTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid respubliqa address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid respubliqa address" in e.error['message'])
