...
OutFile /home/user/worked/ResPubliqa/respubliqa-0.9.3.1-win64-setup.exe
!if "64" == "64"
...
VIAddVersionKey ProductVersion "0.9.3.1"
VIAddVersionKey CompanyName "${COMPANY}"
VIAddVersionKey CompanyWebsite "${URL}"
VIAddVersionKey FileVersion "0.9.3.1"
...
Section -post SEC0001
    ...
    WriteRegStr HKCU "SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\$(^Name)" DisplayVersion "0.9.3.1"
