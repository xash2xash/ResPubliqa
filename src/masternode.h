...
// Copyright (c) 2015-2022 The ResPubliqa developers
...
#define MASTERNODE_CHECK_SECONDS 8
...
//
// The Masternode Class. For managing the Obfuscation process. It contains the input of the 10000 RSQ, signature to prove
...
public:
    ...
    /// Is the input associated with collateral public key? (and there is 10000 RSQ - checking if valid masternode)
