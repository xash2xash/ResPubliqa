...
/** Utility functions used by the ResPubliqa Qt UI.
 */
namespace GUIUtil
{
...
// Render ResPubliqa addresses in monospace font
...
// Parse "respubliqa:" URI into recipient object, return true on successful parsing
