...
#include "qt/respubliqa/forms/ui_addresseswidget.h"
#include "qt/respubliqa/addresslabelrow.h"
#include "qt/respubliqa/addnewaddressdialog.h"
...
AddressesWidget::AddressesWidget(ResPubliqaGUI* parent) :
    PWidget(parent),
    ui(new Ui::AddressesWidget)
{
    ...
    // Address
    ui->labelAddress->setText(tr("Enter ResPubliqa address"));
