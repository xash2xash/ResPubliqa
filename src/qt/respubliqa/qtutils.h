...
bool openDialogWithOpaqueBackgroundY(QDialog *widget, ResPubliqaGUI *gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog *widget, ResPubliqaGUI *gui, double posX = 3);
