...
#include "qt/respubliqa/forms/ui_navmenuwidget.h"
...
NavMenuWidget::NavMenuWidget(ResPubliqaGUI *mainWindow, QWidget *parent) :
    ...
    ui(new Ui::NavMenuWidget)
{
    ...
    setCssProperty(ui->imgLogo, "img-nav-logo-respubliqa");
