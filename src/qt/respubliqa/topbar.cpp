...
#include "qt/respubliqa/forms/ui_topbar.h"
#include <QPixmap>
#include "qt/respubliqa/lockunlock.h"
#include "qt/respubliqa/qtutils.h"
#include "qt/respubliqa/receivedialog.h"
...
TopBar::TopBar(ResPubliqaGUI* _mainWindow, QWidget *parent) :
...
void TopBar::loadWalletModel(){
    ...
    // update the display unit, to not use the default ("ResPubliqa")
    updateDisplayUnit();
