...
#include "qt/respubliqa/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/respubliqa/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(ResPubliqaGUI* _window, QWidget *parent) :
