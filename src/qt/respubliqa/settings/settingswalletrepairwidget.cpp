...
#include "qt/respubliqa/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/respubliqa/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(ResPubliqaGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to ResPubliqaGUI::handleRestart()
