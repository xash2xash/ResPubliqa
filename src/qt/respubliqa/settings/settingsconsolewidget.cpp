...
#include "qt/respubliqa/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/respubliqa/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(ResPubliqaGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(){
    ...
    message(CMD_REPLY, (tr("Welcome to the ResPubliqa RPC console.") + "<br>" +
