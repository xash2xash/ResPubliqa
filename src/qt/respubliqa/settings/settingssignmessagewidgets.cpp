...
#include "qt/respubliqa/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(ResPubliqaGUI* _window, QWidget *parent) :
