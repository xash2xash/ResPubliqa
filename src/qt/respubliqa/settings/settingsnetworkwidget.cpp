...
#include "qt/respubliqa/settings/settingsnetworkwidget.h"
#include "qt/respubliqa/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/respubliqa/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(ResPubliqaGUI* _window, QWidget *parent) :
