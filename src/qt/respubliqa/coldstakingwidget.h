...
#include "qt/respubliqa/furabstractlistitemdelegate.h"
#include "qt/respubliqa/txviewholder.h"
#include "qt/respubliqa/tooltipmenu.h"
#include "qt/respubliqa/sendmultirow.h"
#include "qt/respubliqa/coldstakingmodel.h"
#include "qt/respubliqa/contactsdropdown.h"
...
public:
    explicit ColdStakingWidget(ResPubliqaGUI* parent);
    ~ColdStakingWidget();
