...
public:
    ...
    void setupUi(QWidget *PrivacyWidget)
    {
        ...
        btnTotalzRSQ = new OptionButton(right);
        btnTotalzRSQ->setObjectName(QStringLiteral("btnTotalzRSQ"));
        btnTotalzRSQ->setMinimumSize(QSize(0, 50));

        verticalLayout_5->addWidget(btnTotalzRSQ);
    ...
    void retranslateUi(QWidget *PrivacyWidget)
    {
        ...
        labelEmpty->setText(QApplication::translate("PrivacyWidget", "N/A", Q_NULLPTR));
