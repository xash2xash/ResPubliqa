...
#include "qt/respubliqa/pfborderimage.h"
...
public:
    ...
    void setupUi(QDialog *WelcomeContentWidget)
    {
        ...
        layoutIcon4 = new QVBoxLayout(layoutIcon3_2);
        ...
        layoutIcon4->addWidget(pushNumber3, 0, Qt::AlignVCenter);
    ...
    void retranslateUi(QDialog *WelcomeContentWidget)
    {
        ...
        pushName3->setText(QApplication::translate("WelcomeContentWidget", "Masternodes", Q_NULLPTR));
...
"ResPubliqa Core Wallet", Q_NULLPTR));
        labelMessage2->setText(QApplication::translate("WelcomeContentWidget", "ResPubliqa is the world\342\200\231s most innovative Proof of Stake blockchain based technology. Developed by a team of highly experienced developers and cryptographers.", Q_NULLPTR));
        labelTitle3->setText(QApplication::translate("WelcomeContentWidget", "How ResPubliqa respects your privacy?", Q_NULLPTR));
        labelMessage3->setText(QApplication::translate("WelcomeContentWidget", "<html><head/><body><p>As our manifesto says: Privacy is a non-negotiable basic human right; it grants users the freedom to share their data whenever and with whomever they want - ResPubliqa believes in self sovereignty.</p></body></html>", Q_NULLPTR));
        labelTitle4->setText(QApplication::translate("WelcomeContentWidget", "What is a Masternode?", Q_NULLPTR));
        labelMessage4->setText(QApplication::translate("WelcomeContentWidget", "The masternode network is ResPubliqa's second layer network on top of the blockchain that enables our DAO to provide decentralized governance and a treasury.", Q_NULLPTR));
    } // retranslateUi
