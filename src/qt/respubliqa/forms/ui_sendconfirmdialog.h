...
"}"));
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 556, 672));
...
"}"));
    ...
    void retranslateUi(QWidget *TxDetailDialog)
    {
        ...
        textAmount->setText(QApplication::translate("TxDetailDialog", "2 RSQ", Q_NULLPTR));
        ...
        textFee->setText(QApplication::translate("TxDetailDialog", "0.0001 RSQ", Q_NULLPTR));
