...
#include "qt/respubliqa/forms/ui_dashboardwidget.h"
#include "qt/respubliqa/sendconfirmdialog.h"
#include "qt/respubliqa/txrow.h"
...
DashboardWidget::DashboardWidget(ResPubliqaGUI* parent) :
    PWidget(parent),
    ui(new Ui::DashboardWidget)
{
    ...
    // Staking Information
    ui->labelMessage->setText(tr("Amount of RSQ staked."));
    ...
    ui->labelAmountPiv->setText("0 RSQ");
    ...
    ui->btnHowTo->setText(tr("How to get RSQ"));
...
void DashboardWidget::loadWalletModel(){
    ...
    // update the display unit, to not use the default ("RSQ")
    updateDisplayUnit();
}
...
const QMap<int, std::pair<qint64, qint64>> DashboardWidget::getAmountBy() {
    ...
    for (int i = 0; i < size; ++i) {
        ...
        bool isPiv = modelIndex.data(TransactionTableModel::TypeRole).toInt() != TransactionRecord::StakeZRSQ;
...
bool DashboardWidget::loadChartData(bool withMonthNames) {
    ...
    chartData->amountsByCache = getAmountBy(); // pair RSQ, zRSQ
...
void DashboardWidget::onChartRefreshed() {
    ...
    // init sets
    set0 = new QBarSet("RSQ");
    set1 = new QBarSet("zRSQ");
