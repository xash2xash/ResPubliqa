...
#include "qt/respubliqa/forms/ui_receivewidget.h"
...
#include "qt/respubliqa/addressholder.h"
...
ReceiveWidget::ReceiveWidget(ResPubliqaGUI* parent) :
    PWidget(parent),
    ui(new Ui::ReceiveWidget)
{
    ...
    ui->labelSubtitle1->setText(tr("Scan the QR code or copy the address to receive RSQ."));
