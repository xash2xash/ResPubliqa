...
#include "qt/respubliqa/coldstakingwidget.h"
#include "qt/respubliqa/forms/ui_coldstakingwidget.h"
#include "qt/respubliqa/qtutils.h"
#include "amount.h"
#include "guiutil.h"
#include "qt/respubliqa/requestdialog.h"
#include "qt/respubliqa/tooltipmenu.h"
#include "qt/respubliqa/furlistrow.h"
...
ColdStakingWidget::ColdStakingWidget(ResPubliqaGUI* parent) :
    PWidget(parent),
    ...
    isLoading(false)
{
    ...
    /* Subtitle */
    ui->labelSubtitle1->setText(tr("You can delegate your RSQs, letting a hot node (24/7 online node)\nstake on your behalf, while you keep the keys securely offline."));
    ...
    ui->labelSubtitle2->setText(tr("Accept RSQ delegation / Delegate RSQ"));
    ...
    ui->btnCoinControl->setSubTitleClassAndText("text-subtitle", "Select RSQ outputs to delegate.");
...
void ColdStakingWidget::updateStakingTotalLabel()
{
    ...
    ui->labelStakingTotal->setText(tr("Total Staking: %1").arg(
            (total == 0) ? "0.00 RSQ" : GUIUtil::formatBalance(total, nDisplayUnit))
    );
}
