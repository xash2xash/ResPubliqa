...
#include "qt/respubliqa/coincontrolpivwidget.h"
#include "qt/respubliqa/forms/ui_coincontrolpivwidget.h"
    ...
    ui(new Ui::CoinControlPivWidget)
{
    ...
    ui->labelTitle->setText("Select RSQ Outputs to Spend");
    ...
    ui->labelTitleAmount->setText("RSQ");
    ...
    ui->labelValueAfter->setText("0.00 RSQ");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 RSQ");
    ui->labelValueFee->setText("0.00 RSQ");
