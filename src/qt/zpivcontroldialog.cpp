// Copyright (c) 2017-2020 The ResPubliqa developers
    ...
    model(0)
{
    ...
    // Title
    ui->labelTitle->setText(tr("Select zRSQ Denominations to Spend"));
    ...
    for (const CMintMeta& mint : setMints) {
        ...
        if(!fSpendable) {
            ...
            if(nConfirmations < Params().Zerocoin_MintRequiredConfirmations())
                ...
                strReason = "Your wallet is locked. Impossible to spend zRSQ.";
            else if (!mint.isSeedCorrect)
                strReason = "The zRSQ seed used to mint this zRSQ is not the same as currently hold in the wallet";
            else
