...
// Copyright (c) 2015-2018 The ResPubliqa developers
...
/* ResPubliqa GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "ResPubliqa"
#define QAPP_ORG_DOMAIN "respubliqa.org"
#define QAPP_APP_NAME_DEFAULT "ResPubliqa-Qt"
#define QAPP_APP_NAME_TESTNET "ResPubliqa-Qt-testnet"
