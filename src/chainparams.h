 ...
 * ResPubliqa system. There are three: the main network on which people trade goods
...
public:
    ...
    int ResPubliqaBadBlockTime() const { return nResPubliqaBadBlockTime; }
    int ResPubliqaBadBlocknBits() const { return nResPubliqaBadBlocknBits; }
...
protected:
    ...
    int nLastPOWBlock;
    int64_t nResPubliqaBadBlockTime;
    unsigned int nResPubliqaBadBlocknBits;
