/* src/config/respubliqa-config.h.  Generated from respubliqa-config.h.in by configure.  */
/* src/config/respubliqa-config.h.in.  Generated from configure.ac by autoheader.  */
