...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("ResPubliqa Core respubliqa-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  respubliqa-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded respubliqa transaction") + "\n" +
                               "  respubliqa-tx [options] -create [commands]   " + _("Create hex-encoded respubliqa transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded respubliqa transaction
