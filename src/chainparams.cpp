...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (94, uint256("0x00000005e160652b1620f2b281ec619938d0f15cbbbb7c82d814307728ad686a"))  //94 block
    (103, uint256("0x0000001ecb83c7e944b6b0a2c23589be7bd524e82a62dba2f8cdb67cbd4772e0")) // 103 block
    (3811, uint256("0xa193d0427c25a50f641d304d81836aec6950f0c6ddad9c5085772bf3450cbe06")) // 3811 block
    (3833, uint256("0x6dda7c3b1de7c49a3ff8b98cc51e7f6348641adf0d8b181296b994da2e959bfa")) // 3833 block   
    ;
    
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1643710665, // * UNIX timestamp of last checkpoint block
    7177,          // * total number of transactions between genesis and last checkpoint
...
public:
    CMainParams()
    {
        ...
        vAlertPubKey = ParseHex("0454501d1ac283b571c0016382898fbdd4aff6ed88243bb3299ba1b77bdff3495f9ba7027059e997ed3c04bf52d3f08fbce159ffe3ccbbc2734ddf1a21586041f6");
        nDefaultPort = 9099;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // ResPubliqa starting difficulty is 1 / 2^12
...
//seed nodes
        ...
        zerocoinModulus = "25195908475657893494027183240048398571429282126204032027777137836043662020707595556264018525880784"
            ...
            "6507761337985909570009733045974880842840179909010064245869181719511874612151517265463228221686998754918242243363"
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nLastPOWBlock = 200;
        nResPubliqaBadBlockTime = 1489001494; // Skip nBit validation of Block 259201 per PR #915
        nResPubliqaBadBlocknBits = 0x1e0a20bd; // Skip nBit validation of Block 201 per PR #915
        nMaturity = 15;
        nStakeMinDepth = 100;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet respubliqa addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 135);  // Testnet respubliqa script addresses start with 'w'
        base58Prefixes[STAKING_ADDRESS] = std::vector<unsigned char>(1, 125);     // starting with 's'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet respubliqa BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet respubliqa BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet respubliqa BIP44 coin type is '1' (All coin's testnet default)
