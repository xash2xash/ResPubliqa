// Copyright (c) 2017-2018 The ResPubliqa developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef ResPubliqa_ZRSQWALLET_H
#define ResPubliqa_ZRSQWALLET_H
...
public:
    CzRSQWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZRSQ(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZRSQ(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
