...
#ifndef ResPubliqa_ZRSQTRACKER_H
#define ResPubliqa_ZRSQTRACKER_H
...
public:
    CzRSQTracker(std::string strWalletFile);
    ~CzRSQTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzRSQWallet* zRSQWallet = NULL);
...
#endif //ResPubliqa_ZRSQTRACKER_H
