...
1. Clone the ResPubliqa source code:

        git clone https://github.com/ResPubliqa/respubliqa.git
        cd respubliqa
...
ResPubliqa is now available at `./src/respubliqad`

Before running, you may create an empty configuration file:

    mkdir -p "/Users/${USER}/Library/Application Support/respubliqa"

    touch "/Users/${USER}/Library/Application Support/respubliqa/respubliqa.conf"

    chmod 600 "/Users/${USER}/Library/Application Support/respubliqa/respubliqa.conf"

The first time you run respubliqad, it will start downloading the blockchain. This process could take many hours, or even days on slower than average systems.

You can monitor the download process by looking at the debug.log file:

    tail -f $HOME/Library/Application\ Support/respubliqa/debug.log

Other commands:
-------

    ./src/respubliqad -daemon # Starts The ResPubliqa daemon.
    ./src/respubliqa-cli --help # Outputs a list of command-line options.
    ./src/respubliqa-cli help # Outputs a list of RPC commands when the daemon is running.
