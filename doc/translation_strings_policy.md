...
This document provides guidelines for internationalization of the ResPubliqa Core software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        <source>%n active connection(s) to ResPubliqa network</source>
        <translation>
            <numerusform>%n active connection to ResPubliqa network</numerusform>
            <numerusform>%n active connections to ResPubliqa network</numerusform>
        </translation>
    </message>
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `respubliqa_en.ts` remains unchanged.
