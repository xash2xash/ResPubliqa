...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/respubliqa-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/respubliqa-cli.cpp \
           src/respubliqa-tx.cpp \
           src/respubliqa.cpp \
           src/db.cpp \
...
RESOURCES += src/qt/respubliqa.qrc src/qt/respubliqa_locale.qrc

TRANSLATIONS += src/qt/locale/respubliqa_bg.ts \
                src/qt/locale/respubliqa_de.ts \
                src/qt/locale/respubliqa_en.ts \
                src/qt/locale/respubliqa_es.ts \
                src/qt/locale/respubliqa_fi.ts \
                src/qt/locale/respubliqa_fr.ts \
                src/qt/locale/respubliqa_it.ts \
                src/qt/locale/respubliqa_ja.ts \
                src/qt/locale/respubliqa_pl.ts \
                src/qt/locale/respubliqa_pt.ts \
                src/qt/locale/respubliqa_ru.ts \
                src/qt/locale/respubliqa_sk.ts \
                src/qt/locale/respubliqa_sv.ts \
                src/qt/locale/respubliqa_vi.ts \
                src/qt/locale/respubliqa_zh_CN.ts \
                src/qt/locale/respubliqa_zh_TW.ts
