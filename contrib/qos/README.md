...
This means one can have an always-on respubliqad instance running, and another local respubliqad/respubliqa-qt instance which connects to this node and receives blocks from it.
