Contributing to ResPubliqa Core
============================

The ResPubliqa Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/respubliqa-altc/respubliqa/blob/master/doc/translation_process.md)
...
The following applies to code changes to the ResPubliqa Core project, and is not to be
confused with overall ResPubliqa Network Protocol consensus changes.

Whether a pull request is merged into ResPubliqa Core rests with the project merge
...
Patches that change ResPubliqa consensus rules are considerably more involved than
...
Where a patchset proposes to change the ResPubliqa consensus, it must have been
...
The project leader is the release manager for each ResPubliqa Core release.
